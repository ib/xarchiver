...
typedef struct Prefs_dialog_data
{
	...
	GtkWidget *check_show_comment, *check_sort_filename_column, *advanced_isearch, *show_location_bar, *show_sidebar, *show_toolbar, *combo_prefered_viewer, *combo_prefered_archiver, *combo_prefered_custom_cmd;
