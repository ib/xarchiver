...
{
	archive->can_test = !(archive->type == XARCHIVETYPE_COMPRESS || archive->type == XARCHIVETYPE_CPIO || archive->type == XARCHIVETYPE_AR || archive->type == XARCHIVETYPE_LZMA || archive->type == XARCHIVETYPE_TAR);
