...
void xa_rar_list (XArchive *archive)
{
	...
	if (rar_version == 5)
	{
		...
		const gchar *titles[] = {_("Original Size"), _("Compressed"), _("Ratio"), _("Date"), _("Time"), _("Permissions"), _("CRC")};
	...
	else
	{
		...
		const gchar *titles[] = {_("Original Size"), _("Compressed"), _("Ratio"), _("Date"), _("Time"), _("Permissions"), _("CRC"), _("Method"), _("Version")};
