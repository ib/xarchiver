...
int output_fd,error_fd,child_pid,num_cols, x;
gboolean archive_error , done , bz_gz;
gulong compressor_pid;
GtkWidget *dialog , *textview, *scrollwin, *vbox, *OutputWindow , *File_Selector , *extract_window;
